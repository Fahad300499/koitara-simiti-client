        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            {/* admin only links */}
            {
              role === 'admin' && <>
                <li>
                  <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Approve Payment" to="/dashboard/approve-payment">
                    <RiEBikeFill />
                    <span className="is-drawer-close:hidden">Approve Payment</span>
                  </NavLink>
                </li>
                <li>
